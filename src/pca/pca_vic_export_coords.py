...
def main():
    ...
    ap.add_argument("-target_transform_path",  type=str, required=True, help="")
    ...
    joblib.dump(value=target_trans, filename=args.target_transform_path)
