...
class RandomTaskView(gui3d.TaskView):
    ...
    def __init__(self, category):
        gui3d.TaskView.__init__(self, category, 'Khanh')
        ...
        def onClicked(event):
            ...
            obj_path = '/home/khanhhh/data_1/projects/Oh/data/3d_human/make_human/test_random.obj'
            exportObj(obj_path, self.human)

def exportObj(filepath, human):
    ...
    wavefront.writeObjFile(filepath, meshes, True, None)
